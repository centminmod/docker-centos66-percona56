...
RUN rm -rf /var/lib/rpm/__db.00* && rpm --rebuilddb && yum -y install Percona-Server-server-56 Percona-Server-client-56 Percona-Server-shared-56 --disablerepo=epel && rm -rf /var/cache/* && echo "" > /var/log/yum.log;
